                ...
                <div class="card-header">
                    ...
                    <div class="card-tools d-flex">
                        <div class="btn-group-sm" style="margin-right: 2rem;">
                            <a href="/admin-panel/categories/export/pdf" class="btn btn-danger">Export to PDF</a>
                            <a href="/admin-panel/categories/export/word" class="btn btn-primary">Export to Word</a>
                            <a href="/admin-panel/categories/export/excel" class="btn btn-success">Export to Excel</a>
                        </div>
